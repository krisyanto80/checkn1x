...
apt install -y --no-install-recommends linux-image-$_ARCH live-boot usbmuxd libusbmuxd-tools console-data console-setup console-locales keyboard-configuration
